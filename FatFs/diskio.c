...
DWORD get_fattime (void)
{
    ...
    return (((unsigned long)sjxx_type.year-1980)<<25)|((unsigned long)sjxx_type.month<<21)|((unsigned long)sjxx_type.day<<16)|((unsigned long)sjxx_type.hour<<11)|((unsigned long)sjxx_type.minute<<5)|((unsigned long)sjxx_type.second>>1);
}
